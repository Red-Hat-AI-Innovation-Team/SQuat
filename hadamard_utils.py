# Adapted from https://github.com/spcl/QuaRot/blob/main/fake_quant/hadamard_utils.py
...
def apply_exact_had_to_linear_o(module, had_dim=-1):
    W_ = module.weight.data
    dtype = W_.dtype
    dev = W_.device
    init_shape = W_.shape
...
def apply_exact_had_to_linear_v(module, had_dim=-1):
    W_ = module.weight.data
    dtype = W_.dtype
    dev = W_.device
    # init_shape = W_.shape
